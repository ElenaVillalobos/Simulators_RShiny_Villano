...
function(input,output){
 ...
 proba_ll <- reactive({(Q_value())/((Q_value())+(Q_time()))})
 ...
 output$ploti <- renderPlot({ 
  ...
  pretty_scatter <- function(title_plot,col_axes,
   ...
   axis(2,col=col_axes,col.axis=col_axes,at=actual_y)
  ...
  layout(matrix(c(1,1,2,2,6,6,
                  ...
                  3,3,4,4,6,6,
                  0,5,5,0,6,6,
                  0,5,5,0,6,6),ncol=6,byrow=T))
  
  pretty_scatter('Value Function',gray[5],
                 'Magnitude',c(1000,7000),seq(1000,7000,1000),
                 'Value',c(0,7000),seq(0,7000,2000))
  pretty_points(x_ss(),v_ss(),navy[1])
  pretty_points(x_ll(),v_ll(),navy[1])
  
  pretty_scatter('Weight Function',gray[5],
                 'Time',c(1,10),seq(1,10,1),
                 'Weight',c(0,10),seq(1,10,1))
  pretty_points(t_ss(),w_ss(),navy[1])
  pretty_points(t_ll(),w_ll(),navy[1])
  
  pretty_scatter('Differences in Value',gray[5],
                 'Difference of each question',c(1,24),seq(1,23,2),
                 'Value of Difference',c(0,200),seq(0,200,40))
  ...
  pretty_scatter('Tradeoff Function',gray[5],
                 'Difference of each question',c(1,24),seq(1,23,2),
                 'Value of Difference',c(0,10),seq(0,10,2))
  ...
  pretty_scatter('Choice probability',gray[5],
